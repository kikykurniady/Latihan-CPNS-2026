...
@DriftDatabase(
    tables: [QuestionsTable, SessionsTable, BookmarksTable],
    daos: [QuestionDao, SessionDao, BookmarkDao])
  ...
  Future<void> _seedQuestions() async {
    final questions = [
      ...
      const model.Question(
        ...
        correctAnswer: 2,
        explanation:
            'Sila keempat berbunyi "Kerakyatan yang dipimpin oleh hikmat kebijaksanaan dalam permusyawaratan/perwakilan" yang mengandung makna musyawarah mufakat.',
        difficulty: 'mudah',
        tkpWeights: null,
      ),
      const model.Question(
        ...
        correctAnswer: 1,
        explanation:
            'Lambang sila kedua, "Kemanusiaan yang adil dan beradab", adalah rantai.',
        difficulty: 'mudah',
        tkpWeights: null,
      ),
      const model.Question(
      ...
      const model.Question(
        ...
        subTopic: 'UUD 1945',
        question:
            'Pasal dalam UUD 1945 yang mengatur tentang Hak Asasi Manusia (HAM) adalah...',
        options: [
          'A. Pasal 27',
          'B. Pasal 28A-J',
          'C. Pasal 29',
        ...
        correctAnswer: 1,
        explanation:
            'Pasal 28A hingga 28J dalam UUD 1945 secara khusus mengatur tentang Hak Asasi Manusia.',
        difficulty: 'sedang',
        tkpWeights: null,
      ),
      const model.Question(
        ...
        options: [
          'A. Samudera Hindia',
          'B. Papua Nugini',
          'C. Malaysia, Singapura, Filipina',
          'D. Timor Leste',
          'E. Australia'
        ],
        correctAnswer: 2,
        explanation:
            'Di sebelah utara, Indonesia berbatasan darat dengan Malaysia (di Pulau Kalimantan) dan laut dengan Malaysia, Singapura, dan Filipina.',
        difficulty: 'sulit',
        tkpWeights: null,
      ),
      const model.Question(
        ...
        correctAnswer: 2,
        explanation:
            'Sumpah Pemuda merupakan hasil Kongres Pemuda Kedua yang diselenggarakan pada 27-28 Oktober 1928.',
        difficulty: 'sedang',
        tkpWeights: null,
      ),
      const model.Question(
        ...
        options: [
          ...
          'D. Patah tumbuh hilang berganti',
          'E. Berat sama dipikul, ringan sama dijinjing'
        ],
        correctAnswer: 0,
        explanation:
            'Bhinneka Tunggal Ika adalah semboyan bangsa Indonesia yang berarti "berbeda-beda tetapi tetap satu jua".',
        difficulty: 'mudah',
        tkpWeights: null,
      ),
      // TIU
      ...
      const model.Question(
        ...
        correctAnswer: 0,
        explanation:
            '"Maya" berarti tidak nyata atau hanya ada dalam angan-angan, sehingga antonimnya adalah "nyata".',
        difficulty: 'mudah',
        tkpWeights: null,
      ),
      const model.Question(
        ...
        correctAnswer: 1,
        explanation:
            'Api menyebabkan sesuatu menjadi terbakar. Air menyebabkan sesuatu menjadi basah.',
        difficulty: 'sedang',
        tkpWeights: null,
      ),
      const model.Question(
        ...
        correctAnswer: 3,
        explanation:
            'Ini adalah deret Fibonacci, di mana setiap angka adalah jumlah dari dua angka sebelumnya. 8 + 13 = 21.',
        difficulty: 'sedang',
        tkpWeights: null,
      ),
      const model.Question(
        ...
        correctAnswer: 0,
        explanation:
            'Pola pengurangannya adalah -5, -10, -15, -20, -25. Jadi, 50 - 25 = 25.',
        difficulty: 'sedang',
        tkpWeights: null,
      ),
      const model.Question(
        ...
        options: [
          ...
          'B. Gambar persegi',
          'C. Gambar segitiga',
          'D. Gambar jajar genjang',
          'E. Gambar panah'
        ],
        correctAnswer: 4,
        explanation:
            'A, B, C, dan D adalah bentuk geometri dasar tertutup, sedangkan E (panah) adalah bentuk yang lebih kompleks dan memiliki arah.',
        difficulty: 'sulit',
        tkpWeights: null,
      ),
      const model.Question(
        ...
        subTopic: 'Figural',
        question:
            'Manakah gambar selanjutnya dari seri gambar berikut? [Gambar seri rotasi]',
        options: ['A', 'B', 'C', 'D', 'E'],
        correctAnswer: 0,
        explanation:
      ...
      const model.Question(
        ...
        correctAnswer: 3,
        explanation:
            'Pilihan D menunjukkan sikap melayani yang baik tanpa mengorbankan seluruh waktu kerja. Pilihan E juga baik, tapi kurang efisien. Pilihan A, B, C menunjukkan kurangnya jiwa melayani.',
        difficulty: 'sedang',
      ...
      const model.Question(
        ...
        question:
            'Anda ditempatkan di daerah yang memiliki budaya sangat berbeda dengan Anda. Apa yang Anda lakukan?',
        options: [
      ...
      const model.Question(
        ...
        correctAnswer: 2,
        explanation:
            'Inisiatif untuk belajar dan mengembangkan kemampuan TIK adalah cerminan profesionalisme. Pilihan C menunjukkan sikap proaktif dan bertanggung jawab.',
        difficulty: 'sedang',
      ...
      const model.Question(
        ...
        question:
            'Anda menemukan kesalahan dalam laporan yang dibuat oleh rekan kerja Anda dan akan segera dipresentasikan. Apa yang Anda lakukan?',
        options: [
      ...
      const model.Question(
        ...
        correctAnswer: 2,
        explanation:
            'Memberikan pelayanan prima kepada semua lapisan masyarakat, terutama kelompok rentan, adalah kewajiban. Pilihan C menunjukkan empati dan pelayanan yang tulus.',
        difficulty: 'sedang',
      ...
      const model.Question(
        ...
        subTopic: 'Profesionalisme',
        question:
            'Atasan memberikan tugas yang tidak sesuai dengan keahlian Anda. Bagaimana Anda menanggapinya?',
        options: [
        ...
        correctAnswer: 2,
        explanation:
            'Seorang profesional harus jujur tentang kemampuannya, namun tetap menunjukkan kemauan untuk berkembang dan bertanggung jawab. Pilihan C adalah sikap yang paling profesional dan positif.',
        difficulty: 'sedang',
        tkpWeights: [1, 2, 5, 3, 4],
      ),
    ];
